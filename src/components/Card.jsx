  ...
  return (
    <div onClick={() => onClick(p)} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      ...
      <div style={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", gap: 10, flexShrink: 0, marginLeft: 12, alignSelf: "stretch" }}>
          ...
          <div onClick={(e) => { e.stopPropagation(); onPlay(p); }} style={{ width: 42, height: 42, borderRadius: "50%", background: p.accentColor, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, color: "#0A0A0F", boxShadow: `0 0 24px ${p.accentColor}30`, cursor: "pointer" }}><PlayIcon size={16} color="#0A0A0F" /></div>
        </div>
      </div>
    </div>
  );
